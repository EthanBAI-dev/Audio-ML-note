...
node ".claude/skills/audio-course-lesson/scripts/check-svg-mobile.mjs"   "音频信号处理二十三讲/第01-05课/figures/mobile"
```
...
node ".claude/skills/audio-course-lesson/scripts/check-readability.mjs" \
  "音频信号处理二十三讲/第01-05课/01-课程导论-电脑要怎么分辨音乐类型.md" \
  "音频信号处理二十三讲/第01-05课/02-声音与波形-一次振动怎样变成录音里那条线.md" \
  "音频信号处理二十三讲/第01-05课/03-强弱响度与音色-音量一样为什么听起来不同.md" \
  "音频信号处理二十三讲/第01-05课/04-模拟声到数字录音-连续的声音怎样变成一串数字.md" \
  "音频信号处理二十三讲/第01-05课/05-音频特征的分类-该从录音里算出什么交给模型.md"
```
