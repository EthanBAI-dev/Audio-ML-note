...
完整方法见[《零基础科普文章改写与配图工作流》](../../参考资料/改写与配图工作流.md)。本批继续使用自然递进的正文结构，不在文章中显示“基础层、进阶层”等编辑脚手架。
...
node ".agents/skills/audio-course-lesson/scripts/check-readability.mjs" \
  "音频信号处理二十三讲/第21-23课/21-频域音频特征-一列频谱怎样压成三个数.md" \
  "音频信号处理二十三讲/第21-23课/22-用Python实现带能量比-2000Hz到底该切在哪一格.md" \
  "音频信号处理二十三讲/第21-23课/23-频谱质心与带宽-怎样量出中心和展开.md"
...
node ".agents/skills/audio-course-lesson/scripts/check-svg-mobile.mjs" \
  "音频信号处理二十三讲/第21-23课/figures/mobile"
```
