...
>
> **读完能做到：** 把 STFT 结果画成可信的声谱图　·　说出颜色代表的究竟是哪一个量　·　列出比较两张声谱图必须统一的条件

<picture>
  <source media="(max-width: 640px)" srcset="figures/mobile/00-course-position-16.svg">
  <img src="figures/desktop/00-course-position-16.svg" alt="第 16 课属于第 4 组「把频谱整理成模型输入」，本组共 5 课">
</picture>
...
STFT 中的每个格子是一个**复数**（[第 11 课](../零基础版_11-15/11-复数的模与相位-为什么声音中的振动需要二维坐标.md)讲过）。它同时记录强度和起始位置；如果现在只想用颜色表示“这个时刻的这种振动有多强”，就先取它的模，再平方：
