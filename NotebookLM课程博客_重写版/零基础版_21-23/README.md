...
| 课 | 文章 | 本篇只解决什么 |
|---|---|---|
| 21 | [频域特征怎样概括一帧声音：带能量比、频谱质心与带宽](21-频域特征怎样概括一帧声音-带能量比质心与带宽.md) | 从比例、中心和扩散三个问题建立概念框架，不提前展开完整代码 |
| 22 | [用 Python 实现带能量比（BER）：怎样正确切分频率箱？](22-用Python实现带能量比BER-怎样正确切分频率箱.md) | 用真实频率轴切分频率箱，沿正确矩阵轴逐帧计算稳定的 BER |
| 23 | [频谱质心与带宽：怎样量出声音频率的中心与扩散？](23-频谱质心与带宽怎么计算-声音频率的中心与扩散.md) | 推导质心和带宽，固定幅度加权口径，并说明静音与录音条件的影响 |
