...
<picture>
  <source media="(max-width: 640px)" srcset="../../零基础版_21-23/figures/mobile/00-course-position-22.svg">
  <img src="../../零基础版_21-23/figures/desktop/00-course-position-22.svg" alt="二十三课中的第二十二课，从头实现带能量比">
</picture>
...
<picture>
  <source media="(max-width: 640px)" srcset="../../零基础版_21-23/figures/mobile/22-ber-axis-contract.svg">
  <img src="../../零基础版_21-23/figures/desktop/22-ber-axis-contract.svg" alt="功率声谱图沿频率方向分成低频和高频，并逐列计算带能量比">
</picture>
...
<picture>
  <source media="(max-width: 640px)" srcset="../../零基础版_21-23/figures/mobile/22-split-bin-bug.svg">
  <img src="../../零基础版_21-23/figures/desktop/22-split-bin-bug.svg" alt="2000 Hz 正确分界为第 186 格，两个错误算法分别得到第 185 格和第 234 格">
</picture>
...
<picture>
  <source media="(max-width: 640px)" srcset="../../零基础版_21-23/figures/mobile/22-ber-tracks-new.svg">
  <img src="../../零基础版_21-23/figures/desktop/22-ber-tracks-new.svg" alt="三段真实音乐在 2000 Hz 分界下的带能量比时间轨迹">
</picture>
...
<picture>
  <source media="(max-width: 640px)" srcset="../../零基础版_21-23/figures/mobile/22-threshold-scan.svg">
  <img src="../../零基础版_21-23/figures/desktop/22-threshold-scan.svg" alt="500 到 4000 Hz 不同分界下三段录音的中位带能量比折线">
</picture>
