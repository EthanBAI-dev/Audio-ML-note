...
*图 1：两条曲线画在一起完全重合，下面那条是逐帧的差——量级在 10⁻⁹，纯粹是浮点舍入。*
...
```text
5 行 × 15 列
参数：sr=22050 frame=400 hop=160 归一化=峰值
```
...
[下一课](../../零基础版_06-10/10-傅里叶变换的直觉-电脑怎样从复杂波形里找出频率.md)换一个角度：**不看曲线随时间怎么起伏，而是问它由哪些高低成分组成。** 那是整个课程后半段的起点。
